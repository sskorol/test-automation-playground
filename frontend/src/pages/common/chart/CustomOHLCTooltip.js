...
class CustomOHLCTooltip extends Component {
    constructor(props) {
        super(props);
...
CustomOHLCTooltip.defaultProps = {
    accessor: d => {
        return {
            date: d.date,
            open: d.open,
    ...
    return (
        ...
        >
            <ToolTipText
                ...
                fontSize={fontSize}
                data-qa="react-stockcharts-static-tooltip"
            >
                <ToolTipTSpanLabel fill={labelFill} key="label" x={0} dy="5">
                    {displayTexts.d}
                </ToolTipTSpanLabel>
                <tspan data-qa="date" key="value" fill={textFill}>
                    {displayDate}
                </tspan>
                <ToolTipTSpanLabel fill={labelFill} key="label_O">
                    {displayTexts.o}
                </ToolTipTSpanLabel>
                <tspan data-qa="open" key="value_O" fill={textFill}>
                    {open}
                </tspan>
                <ToolTipTSpanLabel fill={labelFill} key="label_H">
                    {displayTexts.h}
                </ToolTipTSpanLabel>
                <tspan data-qa="high" key="value_H" fill={textFill}>
                    {high}
                </tspan>
                <ToolTipTSpanLabel fill={labelFill} key="label_L">
                    {displayTexts.l}
                </ToolTipTSpanLabel>
                <tspan data-qa="low" key="value_L" fill={textFill}>
                    {low}
                </tspan>
                <ToolTipTSpanLabel fill={labelFill} key="label_C">
                    {displayTexts.c}
                </ToolTipTSpanLabel>
                <tspan data-qa="close" key="value_C" fill={textFill}>
                    {close}
                </tspan>
                <ToolTipTSpanLabel fill={labelFill} key="label_Vol">
                    {displayTexts.v}
                </ToolTipTSpanLabel>
                <tspan data-qa="volume" key="value_Vol" fill={textFill}>
                    {volume}
                </tspan>
            </ToolTipText>
        </g>
...
export default CustomOHLCTooltip;
